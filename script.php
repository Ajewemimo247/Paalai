...
$HCSET['WHITE_PAGE'] = 'https://paalmind.com/script.php';//PHP/HTML file or URL used for bots
...
$HCSET['API_SECRET_KEY'] = 'v12b548b7ba2d645d89a5284c96bda0f2f';
/*********************************************/
...
function apiRequest($ip, $port, $HCSET, $HCSETdata)
{
    ...
    $url = 'http://'.$host.'/basic?ip=' . $ip . '&port=' . $port . '&key=' . $HCSET['API_SECRET_KEY'] . '&sign=v21316052481&js=false&stage='.$HCSET['stage'];
